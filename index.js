"use strict";
    ...
    let evt = require(__dirname + "/framework/crazy");
...
conf.session;
    ...
    async function authentification() {
        try {
            ...
            else if (fs.existsSync(__dirname + "/auth/creds.json") && session != "sekk") {
                await fs.writeFileSync(__dirname + "/auth/creds.json", atob(session), "utf8");
            }
        }
        catch (e) {
    ...
    setTimeout(() => {
        async function main() {
            ...
            const sockOptions = {
                ...
                browser: ['Sektor-Md', "safari", "1.0.0"],
            ...
            zk.ev.on("messages.upsert", async (m) => {
              ...
              //  console.log(ms) ;
                ...
                const superUserNumbers = [servBot, dj, dj2, dj3,dj4, crazy, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
                const allAllowedNumbers = superUserNumbers.concat(sudo);
                const superUser = allAllowedNumbers.includes(auteurMessage);
                
                var dev = [dj, dj2,dj3,dj4,crazy].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
                function repondre(mes) { zk.sendMessage(origineMessage, { text: mes }, { quoted: ms }); }
                console.log("\t [][]...{Sektor-Md}...[][]");
                ...
                if (ms.key && ms.key.remoteJid === 'status@broadcast' && conf.TELECHARGER_AUTO_STATUS === "oui") {
                  ...
                  try {
                    ...
                    if (ms.message[mtype].contextInfo.mentionedJid && (ms.message[mtype].contextInfo.mentionedJid.includes(idBot) ||  ms.message[mtype].contextInfo.mentionedJid.includes(conf.NUMERO_OWNER + '@s.whatsapp.net'))    /*texte.includes(idBot.split('@')[0]) || texte.includes(conf.NUMERO_OWNER)*/) {
                        ...
                        if(superUser) {console.log('crazy-dev') ; return ;} 
                ...
                var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
                 ...
                 if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                       ...
                                       // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                        const gifLink = "https://raw.githubusercontent.com/LORD-IGWE/SEKTOR-MD/main/media/remover.gif";
                             ...
                             if ( warn >= warnlimit) { 
                              var kikmsg = `Lien detecté ; vous avez atteint le nombre maximal d'avertissement votre sanction est la porte`;
          ...
          await zk.sendMessage(origineMessage, { delete: key });
            ...
            console.log('.... ' + er);
                ...
                if (verifCom) {
                    ...
                    const cd = evt.cm.find((crazy) => crazy.nomCom === (com));
                    if (cd) {
            ...
            for (let i = 0; i < crons.length; i++) {
              ...
              if (crons[i].mute_at != null) {
                ...
                cron.schedule(`${set[1]} ${set[0]} * * *`, async () => {
                  ...
                  zk.sendMessage(crons[i].group_id, { image : { url : './media/chrono.webp'} , caption: "Coucou c'est l'heure de fermer le groupe ; > © CRAZY DEV " });
        ...
        // /
            ...
            zk.ev.on("connection.update", async (con) => {
                ...
                if (connection === "connecting") {
                    ...
                    console.log("✅ connexion a SEKTOR-MD reussie! ");
                    console.log("--");
                    await (0, baileys_1.delay)(200);
                    console.log("------");
                    await (0, baileys_1.delay)(300);
                    console.log("------------------/-----");
                    console.log("SEKTOR-MD☄️ est en ligne\n\n");
    ...
    ║    Prefix : [ ${prefixe} ]
    ║    Mode :${md}
    ║    Nombre de plgns : ${evt.cm.length}︎
    ╚══════════════════╝
    ╔═════◇
    ║𝘽𝙮: > CRAZY DEV⚡️
    ║ 
